...
%       the structures generated by wbGenerateMainStruct.m 
%
...
for n=1:DatasetNumber; % loop that will go through number of datasets within the input structure
   ...
   % NameCorrmatr4=strcat('CovMatr',Number);
...
%     for d=1:length(NeuronOrder);
%         
%         NeuronOrder_resorted(d)=NeuronOrder(outperm(d)); %rearranging NeuronOrder
%         
%     end
